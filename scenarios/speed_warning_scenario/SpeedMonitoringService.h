...
private:
    ...
    void checkSpeedViolation(const std::string& vehicleId, double speed, double x, double y);
    void sendDENM(const std::string& vehicleId, double speed, int dangerLevel, double x, double y);
